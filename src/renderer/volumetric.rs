...
impl VolumetricRenderer {
    pub(crate) fn new(
        ...
        let texture_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                entries: &[
                    // Original full resolued texture data
                    ...
                    // Downsampled 8x resolued texture data
                    wgpu::BindGroupLayoutEntry {
                        binding: 2,
                        visibility: wgpu::ShaderStages::FRAGMENT,
                        ty: wgpu::BindingType::Texture {
                    ...
                    wgpu::BindGroupLayoutEntry {
                        ...
                        ty: wgpu::BindingType::Buffer {
                            ...
                            has_dynamic_offset: false,
                            min_binding_size: wgpu::BufferSize::new(
                                std::mem::size_of::<VolumetricRenderParams>() as wgpu::BufferAddress,
                            ),
                        },
                        count: None,
                    },
                    wgpu::BindGroupLayoutEntry {
                        ...
                        ty: wgpu::BindingType::Buffer {
                            ...
                            has_dynamic_offset: false,
                            min_binding_size: wgpu::BufferSize::new(
                                std::mem::size_of::<SurfaceRenderParams>() as wgpu::BufferAddress,
                            ),
                        },
                        count: None,
                    },
        ...
        let cube =
            Texture::from_raw_bytes::<f32>(device, queue, None, (1, 1, 1), (0, 0, 0), 4, "cube")
                .unwrap();
        ...
        let diffuse_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 6,
                    resource: wgpu::BindingResource::Buffer(wgpu::BufferBinding {
                        buffer: &buffers["volumetric_render_params"],
                        offset: 0,
                        size: wgpu::BufferSize::new(
                            std::mem::size_of::<VolumetricRenderParams>() as wgpu::BufferAddress
                        ),
                ...
                wgpu::BindGroupEntry {
                    binding: 7,
                    resource: wgpu::BindingResource::Buffer(wgpu::BufferBinding {
                        buffer: &buffers["surface_render_params"],
                        offset: 0,
                        size: wgpu::BufferSize::new(
                            std::mem::size_of::<SurfaceRenderParams>() as wgpu::BufferAddress
                        ),
        ...
        let volumetric_rendering_pipeline =
        ...
        let isosurface_rendering_pipeline =
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                label: Some("Volumetric rendering pipeline"),
                layout: Some(&render_pipeline_layout),
                vertex: wgpu::VertexState {
    ...
    pub(crate) fn set_volume(
        ...
        let volume = &cube.texture;
        let downsampled_volume = &cube.downsampled_texture;
        ...
        self.diffuse_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: wgpu::BindingResource::TextureView(&downsampled_volume.view),
                },
                wgpu::BindGroupEntry {
                    binding: 3,
                    resource: wgpu::BindingResource::Sampler(&downsampled_volume.sampler),
                },
                wgpu::BindGroupEntry {
                    binding: 4,
                    resource: wgpu::BindingResource::Buffer(wgpu::BufferBinding {
